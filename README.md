...
Helper scripts are included to safely test the tool (useful in WSL):

sample.sh
Generates a messy directory with various file types
(.txt, .md, .html, .obscure)

cleanup.sh
Hard reset script that moves files back to root and removes folders
